...
from codename_ai.model.boss import WordNetBossModel
...
if __name__ == '__main__':
    ...
    for q_num, random_seed in enumerate(range(2, 10)):
        print(f'第{q_num+1}問##############################')
        ...
        boss_model = WordNetBossModel.setup_model(my_color='blue')
        best_candidate_word, expect_count, expect_words = boss_model.next_hint(game=game)
    ...
    # resulted = gokart.build(CalculateWordDistanceWithWordNet(target_word='犬'), log_level=logging.INFO)
