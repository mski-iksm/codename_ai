...
from codename_ai.model.bert_bl.bert_model import (
    CalculateWordDistanceWithBERT, GetSingleSentenceBertVector)
...
class TestGetSingleSentenceBertVector(unittest.TestCase):

    def test_sentence_to_vector(self):
        resulted = GetSingleSentenceBertVector._sentence_to_vector(sentence='牧場')
